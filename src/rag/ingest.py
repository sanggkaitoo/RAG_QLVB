...
# ĐÃ SỬA LỖI: Tăng thời gian chờ (timeout) lên 60 giây để mạng không bị ngắt sớm
qdrant = QdrantClient(
...
def process_documents():
    ...
    for file_name in files:
        ...
        if not full_text:
            print(f"⚠️ Cảnh báo: File {file_name} rỗng hoặc là ảnh scan. Tiến hành xóa file rác.")
            os.remove(file_path)
        ...
        # ĐÃ SỬA LỖI: Chia nhỏ lô dữ liệu (Batching) để gửi dần lên DB
        batch_size = 100
